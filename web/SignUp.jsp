...
<html lang="en">
    ...
    <head>
        <title>JobC &mdash; Sign Up Page</title>
        <meta charset="utf-8">
                    ...
                    <div class="row align-items-center">
                        ...
                        <nav class="mx-auto site-navigation">
                            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                                ...
                                <li class="d-lg-none"><a href="login.jsp">Sign Up</a></li>
                            </ul>
                        </nav>

                        <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
                            <div class="ml-auto">
                                <a href="Login.jsp" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span
